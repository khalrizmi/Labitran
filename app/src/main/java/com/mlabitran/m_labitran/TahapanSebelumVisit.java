...
public class TahapanSebelumVisit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tahapan_sebelum_visit);
    ...
    private void InitViews(){
        ...
        buttonselanjutnya.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(mContext, TahapanKunjungan.class));
            }
        });
    }
}
